...
const PostJob = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const res = await axiosSecure.post(url, jobData);
      ...
      <div className="card bg-base-200 shadow-xl border border-base-300 max-w-4xl mx-auto">
        <div className="card-body">
          ...
          >
            ...
            <div className="divider md:col-span-2 text-primary font-bold">
              Job Details
            </div>
            ...
            <div className="form-control flex flex-col">
              ...
              <select
                className={`select select-bordered ${
                  errors.classGrade ? "select-error" : ""
                }`}
            ...
            <div className="form-control flex flex-col">
              ...
              <label className="label">
                <span className="label-text-alt text-base-content/60">
                  This is the total amount you will pay the tutor for this
                  session.
                </span>
              </label>
              {errors.budget && (
