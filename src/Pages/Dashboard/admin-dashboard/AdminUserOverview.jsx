...
const AdminUserOverview = () => {
  ...
  // Initialize with empty strings to ensure inputs are "controlled" from the start
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        // This ensures the name and other details are pre-written in the inputs
  ...
  const handleDelete = async () => {
    Swal.fire({
      title: "Are you sure?",
      text: "This action is permanent! All user history will be wiped.",
      icon: "warning",
    ...
    <div className="p-6 bg-base-100 min-h-screen">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-base-content/60">Managing details for: <span className="text-primary font-semibold">{user.name}</span></p>
        </div>
      </div>
            ...
            <div className="card-body items-center text-center">
              <div className="avatar mb-4">
                <div className="w-32 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                  {/* Added fallback for image to prevent console error */}
                  <img 
              ...
              <h2 className="card-title text-2xl">{user.name || "Unnamed User"}</h2>
          ...
          <div className="card bg-red-50 border border-red-200">
            <div className="card-body">
              ...
              <p className="text-xs text-red-800">
                Deleting this user is irreversible.
              </p>
              <button 
          ...
          <div className="card bg-base-100 shadow-xl border border-base-200">
            <div className="card-body">
              <h3 className="card-title mb-6 flex items-center gap-2">
                <FaUserShield className="text-primary" /> Administrative Controls
              </h3>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                
                {/* Name Input - Pre-written from state */}
                ...
                <div className="form-control">
                  <label className="label font-bold text-primary">Modify Role</label>
                  <select 
                    name="role"
                    value={user.role} 
                    onChange={handleInputChange}
                ...
                <div className="form-control">
                  <label className="label font-bold">Update Status</label>
                  <select 
                    name="status"
                    value={user.status} 
                    onChange={handleInputChange}
              ...
              <div className="divider my-6">Contact Details</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="flex items-center gap-3 p-3 bg-base-200 rounded-lg">
                   ...
                   <div>
                     ...
                     <p>{user.tutorData?.phone || user.studentData?.phone || "Not Provided"}</p>
                   </div>
                </div>
                <div className="flex items-center gap-3 p-3 bg-base-200 rounded-lg">
                   ...
                   <div>
                     ...
                     <p>{user.tutorData?.address || user.studentData?.address || "Not Provided"}</p>
                   </div>
                </div>
              </div>
